...
@section('content')
    {{-- Full-bleed wrapper: membatalkan padding/card bawaan Breeze agar tidak "kotak di dalam kotak" --}}
                            ...
                            <div class="p-6">
                                <div class="flex items-start justify-between gap-3">
                                    <div>
                                        ...
                                        <h2 class="mt-1 text-2xl font-semibold text-white">Admin Panel</h2>
                                    </div>
                                ...
                                <div class="mt-6 space-y-2">
                                    ...
                                    <a href="{{ route('admin.addons.index') }}"
                                       class="group flex items-center justify-between rounded-2xl border border-white/10 bg-white/5 px-4 py-3 transition hover:bg-white/10 hover:border-white/20">
                                        <span class="font-medium text-white">Addons</span>
                                        <span class="text-slate-400 group-hover:text-white">↗</span>
                                    </a>
                                ...
                                <div class="mt-6 rounded-2xl border border-white/10 bg-white/5 p-4">
                                    <p class="text-sm text-slate-300">
                                        Pusat komando Admin: klik menu besar dan atur segala keperluan yang dibutuhkan.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <main class="lg:col-span-9">
                        ...
                        <div class="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-white/10 via-white/5 to-transparent p-6 sm:p-8 shadow-[0_20px_60px_-35px_rgba(0,0,0,0.8)]">
                            ...
                            <div class="relative flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                                <div>
                                    <p class="text-xs uppercase tracking-[0.18em] text-slate-300/80">Admin Dashboard</p>
                                    <h1 class="mt-2 text-3xl sm:text-4xl font-semibold text-white">
                                        Selamat datang, Admin 👋
                                    </h1>
                                    <p class="mt-2 max-w-2xl text-slate-300">
                                        Pilih area kerja di bawah untuk mengelola <span class="text-white/90 font-medium">studio</span>,
                                        <span class="text-white/90 font-medium">addons</span>,
                                        <span class="text-white/90 font-medium">features</span>, dan
                                        <span class="text-white/90 font-medium">reports</span>.
                                    </p>
                                </div>
                        ...
                        <section class="mt-6">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                    ...
                                    <div class="relative">
                                        <div class="flex items-start justify-between gap-4">
                                            <div>
                                                ...
                                                <h3 class="mt-2 text-2xl font-semibold text-white">Studios</h3>
                                                <p class="mt-2 text-slate-300">
                                                    Tambah, edit, dan atur studio: harga, kapasitas, lokasi, status.
                                                </p>
                                            </div>
                                        ...
                                        <div class="mt-6 flex flex-wrap gap-2">
                                            <span class="rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs text-slate-200">Create</span>
                                            <span class="rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs text-slate-200">Edit</span>
                                            <span class="rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs text-slate-200">Publish</span>
                                        </div>
                                    </div>
                                </a>
                                   ...
                                   class="group relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-6 sm:p-8 shadow-[0_20px_60px_-35px_rgba(0,0,0,0.8)] transition hover:bg-white/10 hover:border-white/20">
                                    ...
                                    <div class="relative">
                                        <div class="flex items-start justify-between gap-4">
                                            <div>
                                                <p class="text-xs uppercase tracking-[0.18em] text-slate-300/80">Manage</p>
                                                <h3 class="mt-2 text-2xl font-semibold text-white">Addons</h3>
                                                <p class="mt-2 text-slate-300">
                                                    Kelola layanan tambahan: lighting kit, crew, make-up, props, dan lainnya.
                                                </p>
                                            </div>
                                            <div class="shrink-0 rounded-2xl border border-white/10 bg-white/5 px-4 py-2 text-sm text-slate-200">
                                                Open ↗
                                        ...
                                        <div class="mt-6 flex flex-wrap gap-2">
                                            <span class="rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs text-slate-200">Pricing</span>
                                            <span class="rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs text-slate-200">Bundles</span>
                                            <span class="rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs text-slate-200">Availability</span>
                                        </div>
                                    </div>
                                </a>
                                ...
                                <a href="{{ route('admin.features.index') }}"
                                   class="group relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-6 sm:p-8 shadow-[0_20px_60px_-35px_rgba(0,0,0,0.8)] transition hover:bg-white/10 hover:border-white/20">
                                    <div class="absolute -top-24 -right-24 h-64 w-64 rounded-full bg-fuchsia-500/15 blur-3xl transition group-hover:bg-fuchsia-500/25"></div>
                                    <div class="relative">
                                        <div class="flex items-start justify-between gap-4">
                                            <div>
                                                <p class="text-xs uppercase tracking-[0.18em] text-slate-300/80">Manage</p>
                                                <h3 class="mt-2 text-2xl font-semibold text-white">Features</h3>
                                                <p class="mt-2 text-slate-300">
                                                    Atur fasilitas studio: AC, soundproof, green screen, Wi-Fi, dan set lainnya.
                                                </p>
                                            </div>
                                            <div class="shrink-0 rounded-2xl border border-white/10 bg-white/5 px-4 py-2 text-sm text-slate-200">
                                                Open ↗
                                        ...
                                        <div class="mt-6 flex flex-wrap gap-2">
                                            <span class="rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs text-slate-200">Library</span>
                                            <span class="rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs text-slate-200">Tagging</span>
                                            <span class="rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs text-slate-200">Mapping</span>
                                        </div>
                                    </div>
                                </a>
                                ...
                                <a href="{{ route('admin.reports.index') }}"
                                   class="group relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-6 sm:p-8 shadow-[0_20px_60px_-35px_rgba(0,0,0,0.8)] transition hover:bg-white/10 hover:border-white/20">
                                    <div class="absolute -top-24 -right-24 h-64 w-64 rounded-full bg-amber-500/15 blur-3xl transition group-hover:bg-amber-500/25"></div>
                                    <div class="relative">
                                        <div class="flex items-start justify-between gap-4">
                                            <div>
                                                <p class="text-xs uppercase tracking-[0.18em] text-slate-300/80">Review</p>
                                                <h3 class="mt-2 text-2xl font-semibold text-white">Reports</h3>
                                                <p class="mt-2 text-slate-300">
                                                    Pantau laporan dan ringkasan aktivitas sistem dengan tampilan yang rapi.
                                                </p>
                                            </div>
                                            <div class="shrink-0 rounded-2xl border border-white/10 bg-white/5 px-4 py-2 text-sm text-slate-200">
                                                Open ↗
                                        ...
                                        <div class="mt-6 flex flex-wrap gap-2">
                                            <span class="rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs text-slate-200">Audit</span>
                                            <span class="rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs text-slate-200">Export</span>
                                            <span class="rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs text-slate-200">Trends</span>
                                        </div>
                                    </div>
                                </a>
                                ...
                                <form action="{{ route('logout') }}" method="POST"
                                    ...
                                    <div class="flex items-start justify-between gap-4">
                                        <div>
                                            ...
                                            <p class="mt-2 text-slate-300">Keluar dari panel admin dengan aman.</p>
                                        </div>
                                        <button type="submit"
