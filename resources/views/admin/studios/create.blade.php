    ...
    <div class="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-white/10 via-white/5 to-transparent p-6 sm:p-8 shadow-[0_20px_60px_-35px_rgba(0,0,0,0.8)]">
        ...
        <div class="relative flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
                ...
                <h1 class="mt-2 text-3xl sm:text-4xl font-semibold text-white">Tambah Studio</h1>
                <p class="mt-2 max-w-2xl text-slate-300">
                    Buat studio baru dan tentukan harga, kapasitas, serta paket addon/features.
                </p>
            ...
            <div class="hidden sm:flex items-center gap-2">
                <span class="inline-flex items-center rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs text-slate-200">Create</span>
                <span class="inline-flex items-center rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs text-slate-200">Studios</span>
            </div>
        </div>
    </div>

    @php
        // preselect (untuk old() kalau validasi gagal)
        $selectedAddons   = old('addons', []);
        $selectedFeatures = old('features', []);

        $currentStatus = strtolower(old('status', 'active'));
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div class="lg:col-span-8 space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') }}"
                               ...
                               placeholder="Contoh: Studio Podcast Eclipse" required>
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="5"
                                  class="w-full rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-slate-100 placeholder:text-slate-400
                                         focus:outline-none focus:ring-2 focus:ring-indigo-400/50 focus:border-indigo-400/40"
                                  placeholder="Jelaskan konsep, fasilitas, dan kegunaan studio secara singkat dan jelas.">{{ old('description') }}</textarea>
                    ...
                    <div class="rounded-3xl border border-white/10 bg-white/5 p-5 sm:p-6">
                        <div class="flex items-center justify-between gap-3">
                            <div>
                                ...
                                <p class="mt-1 text-xs text-slate-400">Centang addon yang tersedia untuk studio baru ini.</p>
                            </div>
                        ...
                        <div class="mt-4 max-h-56 overflow-auto cool-scroll rounded-2xl border border-white/10 bg-slate-950/30 p-2">
                            <div class="grid gap-2">
                                @foreach($features as $feature)
                                    @php $label = $feature->feature_name ?? $feature->name; @endphp
                ...
                <div class="lg:col-span-4 space-y-5">
                    ...
                    <div class="rounded-3xl border border-white/10 bg-white/5 p-5 sm:p-6">
                        ...
                        <p class="mt-1 text-xs text-slate-400">Upload cover studio. Maks 2MB. Format: JPG/JPEG.</p>
                    ...
                    <div class="rounded-3xl border border-white/10 bg-gradient-to-br from-indigo-500/15 via-white/5 to-transparent p-5 sm:p-6">
                        ...
                        <ul class="mt-2 space-y-2 text-sm text-slate-300">
                            ...
                            <li class="flex gap-2"><span class="text-slate-200">•</span> Deskripsi singkat tapi informatif.</li>
                            <li class="flex gap-2"><span class="text-slate-200">•</span> Harga sesuai paket rental.</li>
                            <li class="flex gap-2"><span class="text-slate-200">•</span> Addon & features sudah dipilih.</li>
                        </ul>
                    </div>
