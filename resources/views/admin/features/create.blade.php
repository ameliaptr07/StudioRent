...
<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-white/10 via-white/5 to-transparent p-6 sm:p-8 shadow-[0_20px_60px_-35px_rgba(0,0,0,0.8)]">
        ...
        <div class="relative flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
                <p class="text-xs uppercase tracking-[0.18em] text-slate-300/80">Admin • Features</p>
                <h1 class="mt-2 text-3xl sm:text-4xl font-semibold text-white">Tambah Feature</h1>
                <p class="mt-2 max-w-2xl text-slate-300">
                    Tambahkan fasilitas baru yang bisa dipilih saat membuat studio.
                </p>
        ...
        <div class="p-5 sm:p-8">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div class="lg:col-span-8 space-y-5">
                    <div>
                        <label class="block text-sm font-semibold text-slate-200 mb-2">Nama Feature</label>
                        <input type="text" name="name" value="{{ old('name', $feature->feature_name ?? '') }}"
                               ...
                               placeholder="Contoh: Soundproof / AC / Green Screen"
                               required>
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="5"
                                  class="w-full rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-slate-100 placeholder:text-slate-400
                                         focus:outline-none focus:ring-2 focus:ring-indigo-400/50 focus:border-indigo-400/40"
                                  placeholder="Jelaskan fungsi/benefit feature ini (singkat, jelas).">{{ old('description') }}</textarea>
                ...
                <div class="lg:col-span-4 space-y-5">
                    <div class="rounded-3xl border border-white/10 bg-gradient-to-br from-indigo-500/15 via-white/5 to-transparent p-5 sm:p-6">
                        <p class="text-sm text-slate-200 font-semibold">Contoh feature populer</p>
                        <ul class="mt-2 space-y-2 text-sm text-slate-300">
                            <li class="flex gap-2"><span class="text-slate-200">•</span> Soundproof</li>
                            <li class="flex gap-2"><span class="text-slate-200">•</span> AC</li>
                            <li class="flex gap-2"><span class="text-slate-200">•</span> Green Screen</li>
                            <li class="flex gap-2"><span class="text-slate-200">•</span> Lighting Softbox</li>
                            <li class="flex gap-2"><span class="text-slate-200">•</span> Fast Wi-Fi</li>
                        </ul>
                    </div>

                    <div class="rounded-3xl border border-white/10 bg-white/5 p-5 sm:p-6">
                        <p class="text-sm text-slate-200 font-semibold">Tip penamaan</p>
                        <p class="mt-2 text-sm text-slate-300">
                            Pakai nama yang ringkas dan konsisten, biar enak dibaca di halaman create studio.
                        </p>
                    </div>
                </div>
            </div>
